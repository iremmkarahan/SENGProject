...
<style>
    ...
    .contact__form textarea {
        ...
        border: 1px solid var(--color-gray-700); /* Use light gray border */
        border-radius: var(--card-border-radius-1); /* Use smaller border radius */
        background: var(--color-white); /* White background for inputs */
        color: var(--color-text-main); /* Input text color */
        font-family: inherit;
        font-size: 0.9rem;
    }
    ...
    .contact__form textarea::placeholder {
        color: var(--color-gray-200); /* Muted gray for placeholders */
    }
